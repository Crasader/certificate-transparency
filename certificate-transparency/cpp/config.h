/* cpp/config.h.  Generated from config.h.in by configure.  */
/* cpp/config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define to 1 if you have the declaration of `INADDR_LOOPBACK', and to 0 if
   you don't. */
...
/* Define to 1 if you have the <leveldb/filter_policy.h> header file. */
#define HAVE_LEVELDB_FILTER_POLICY_H 1
...
#define PACKAGE_BUGREPORT "certificate-transparency@googlegroups.com"
...
/* #undef PTHREAD_T_IS_POINTER */

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Top of the source directory, for tests. */
#define TEST_SRCDIR "."
